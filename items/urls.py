...
urlpatterns = [
    ...
    path(
        'deactivate_campaign/<int:campaign_id>/', views.deactivate_campaign,
        name='deactivate_campaign'),
    path(
        'activate_campaign/<int:campaign_id>/', views.activate_campaign,
        name='activate_campaign'),
    path('manage_campaigns/', views.manage_campaigns, name='manage_campaigns'),
    path(
        'update_campaign/<int:campaign_id>/', views.update_campaign,
        name='update_campaign'),
    path(
        'delete_campaign/<int:campaign_id>/', views.delete_campaign,
