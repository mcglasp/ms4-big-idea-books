...
class ItemForm(forms.ModelForm):
    ...
    class Meta:
        model = Item
        fields = '__all__'
        exclude = ('sku', 'quantity_sold', 'image_url', 'final_price', 'date_added','set_sale_price','original_sale_price', 'active', 'campaign')
...
class CampaignForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['fixed_price'].widget.attrs['placeholder'] = 'ie. 5 or 4.99'
        self.fields['campaign_name'].widget.attrs['placeholder'] = 'Eg. £1 book sale this weekend!'
        self.fields['campaign_name'].initial = ''
        self.fields['campaign_name'].label = '<span class="bold">Choose a name for your campaign</span><span class="italic">This will appear wherever you advertise your sale on the site.</span>'
